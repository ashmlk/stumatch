...
STATIC_URL = "/static/"
STATICFILES_DIRS = [os.path.join(BASE_DIR, "static")]  # checked
...
CELERY_BEAT_SCHEDULE = {
    "update-hot-posts": {"task": "home.tasks.get_hot_posts", "schedule": 1800.0,},
    "update-top-posts": {"task": "home.tasks.get_top_posts", "schedule": 3600.0,},
    "update-uni-posts": {"task": "home.tasks.uni_posts", "schedule": 2700.0,},
